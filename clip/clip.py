...
_MODELS = {
    ...
    "GeoRSCLIP_b_32": "https://huggingface.co/Zilun/GeoRSCLIP/resolve/main/ckpt/RS5M_ViT-B-32.pt",
    "GeoRSCLIP_l_14": "https://huggingface.co/Zilun/GeoRSCLIP/resolve/main/ckpt/RS5M_ViT-L-14.pt",
...
def _download(url: str, root: str):
    ...
    print("Download target ", download_target)
    return download_target
